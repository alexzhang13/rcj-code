...
{	
	...
	if(data.laserL_a <= 1200) { //check if reading is valid LONG FRONT
		temp_range[0] = (data.laserL_a-30.0) * cos((3.1415926535*myRobot->imuDataList[imuSize-1].m_yaw - 282.743338815*data.axis)/180); //-18.0
	...
	if(data.laserL_b <= 1200) { //check if reading is valid LONG BACK
		temp_range[2] = (data.laserL_b+59.25) * cos((3.1415926535*myRobot->imuDataList[imuSize-1].m_yaw - 282.743338815*data.axis)/180);
	...
	if(data.laserS_a <= 250) { //check if reading is valid SHORT RIGHT
		temp_range[1] = (data.laserS_a+13.75) * cos((3.1415926535*myRobot->imuDataList[imuSize-1].m_yaw - 282.743338815*data.axis)/180); //30 - x - 15 = 15 - x 
	...
	if(data.laserS_b <= 250) { //check if reading is valid SHORT LEFT
		temp_range[3] = (data.laserS_b+13.75) * cos((3.1415926535*myRobot->imuDataList[imuSize-1].m_yaw - 282.743338815*data.axis)/180); //x - 15
