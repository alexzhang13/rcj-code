...
char kNNFilter::detectVictim(cv::Mat matTestingNumbers) {
	...
	cout << "XML's found." << endl;

	fsTrainingImages["images"] >> matTrainingImagesAsFlattenedFloats;           // read images section into Mat training images variable
	fsTrainingImages.release();
	cout << "Filled var with image" << endl;		
	
	cv::Ptr<cv::ml::KNearest> kNearest(cv::ml::KNearest::create());            // instantiate the KNN object
	kNearest->train(matTrainingImagesAsFlattenedFloats, cv::ml::ROW_SAMPLE, matClassificationInts);
	cout << "KNN Object Instantiated" << endl;
	...
	cout << "Contours' ROI checked and converted to string of chars." << endl;
